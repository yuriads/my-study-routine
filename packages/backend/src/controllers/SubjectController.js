...
module.exports = {
    ...
    async delete (request, response) {
        ...
        const user_email = request.headers.authorization;//usamos o user_email para saber se o subject que estamos deletando realmente foi criado pelo o usuário
        ...
        const subject = await connection('subjects')
            ...
            if (subject.user_email != user_email){//se o user_email desse subject que buscamos no banco de dados for diferente do user_email que está logado da aplicação vai dá um erro
